    ...
    <div>
      <div className="text-green-600">
        <div>
          ...
          <br />
          <br />
          <p>Welcome to Green Canteen!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of https://green-canteen.netlify.app/'s Website, located at
            https://green-canteen.netlify.app/.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Green Canteen if you do not agree
          ...
          <p>
            We employ the use of cookies. By accessing Green Canteen, you agreed
            to use cookies in agreement with the
            https://green-canteen.netlify.app/'s Privacy Policy.
          </p>
          ...
          <p>
            Unless otherwise stated, https://green-canteen.netlify.app/ and/or
            its licensors own the intellectual property rights for all material
            on Green Canteen. All intellectual property rights are reserved. You
            may access this from Green Canteen for your own personal use
            subjected to restrictions set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from Green Canteen</li>
            <li>Sell, rent or sub-license material from Green Canteen</li>
            <li>Reproduce, duplicate or copy material from Green Canteen</li>
            <li>Redistribute content from Green Canteen</li>
          </ul>
          ...
          <p>
            ...
            https://green-canteen.netlify.app/ does not filter, edit, publish or
            review Comments prior to their presence on the website. Comments do
            not reflect the views and opinions of
            https://green-canteen.netlify.app/,its agents and/or affiliates.
            ...
            https://green-canteen.netlify.app/ shall not be liable for the
          ...
          <p>
            https://green-canteen.netlify.app/ reserves the right to monitor all
          ...
          <p>
            You hereby grant https://green-canteen.netlify.app/ a non-exclusive
          ...
          <p>
            ...
            https://green-canteen.netlify.app/; and (d) the link is in the
          ...
          <p>
            ...
            sending an e-mail to https://green-canteen.netlify.app/. Please
          ...
          <p>
            No use of https://green-canteen.netlify.app/'s logo or other artwork
