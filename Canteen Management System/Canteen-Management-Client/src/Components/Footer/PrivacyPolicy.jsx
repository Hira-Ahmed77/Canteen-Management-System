          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Green Canteen.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Green Canteen, accessible
                from{" "}
                <a
                  href="https://greencanteen.example.com/"
                  rel="noreferrer noopener"
                  target="_blank"
                >
                  https://greencanteen.example.com/
                </a>
              </p>
            </li>
            <li>
