  ...
  return (
    <div>
      <ShopBanner
        title={"blog"}
        img={
          "https://i.ibb.co/fpJFvzL/traditional-food-around-the-world-Travlinmad.jpg"
        }
      ></ShopBanner>
      <div className="grid lg:grid-cols-2 md:grid-cols-2 justify-center my-10 w-3/4 mx-auto">
        <div>
          <div>
            {blogs.map((blog) => (
              <>
        ...
        <div className="px-10">
          ...
          {/* recent post */}
          <h1 className="text-xl font-bold my-5">Resent Post</h1>
          <section className="flex justify-start items-center gap-2">
            <div>
              <img
                className="h-20 w-20 "
                src="https://i.ibb.co/9WkHGPG/360-F-286178925-8zk89-O9u-C5-JJVPvqhv-BMUpa-Rxp8-AFXz-D.jpg"
                alt=""
              />
            </div>
            <div>
              <p className="text-red-700">21 jun 2023</p>
              <h1>Carrot is the most foody product</h1>
            </div>
          </section>
          <section className="flex justify-start items-center  my-2 gap-2">
            <div>
              <img
                className="h-20 w-20 "
                src="https://i.ibb.co/9WkHGPG/360-F-286178925-8zk89-O9u-C5-JJVPvqhv-BMUpa-Rxp8-AFXz-D.jpg"
